...
public class Node extends UnicastRemoteObject implements NodeInterface {
    ...
    private final BigInteger nodeID;                            // BigInteger value of hash of IP address/name of the Node
    private final int port;                                    // port on which the registry for this node is running
    private NodeInterface successor;
    private NodeInterface predecessor;
    private final Set<BigInteger> keys;
    private final List<NodeInterface> fingerTable;
    private final Map<BigInteger, Message> filesMetadata;        //
    private final UpdateOperations updater;                    // this class contains methods for handling file updates
    private final ChordLookup lookup;                            // this class contains methods for looking up keys in a chord ring
